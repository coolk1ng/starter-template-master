  ...
  <div class="header-container">
    <div class="wrapper">
      ...
      <div class="left-wrapper v-link selected">
        <img style="width: 50px" width="50px" height="50px" src="~assets/images/logo.png" alt="">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      userInfo.login(this.userInfo).then(response => {
    ...
    getCodeFun() {
      ...
      sms.sendCode(this.userInfo.phone).then(response => {
        this.timeDown();
      }).catch(e => {
    ...
    weixinLogin() {
      ...
      wx.getLoginParam().then(response => {
        var obj = new WxLogin({
          self_redirect:true,
          id: 'weixinLogin', // 需要显示的容器id
          appid: response.data.appid, // 公众号appid wx*******
          scope: response.data.scope, // 网页默认即可
          redirect_uri: response.data.redirectUrl, // 授权成功后回调的url
